...
// const newArr = supplies.map(supplyObject => {
//   return supplyObject.brand
// })
// console.log(newArr);

const newArr =  businesses.map(busyObj => ({
    name:busyObj.purchasingAgent.nameFirst + busyObj.purchasingAgent.nameLast,
    company: busyObj.companyName,
    phoneNumber: busyObj.phoneWork
}))

// export const getAgentArr = () => {
//   return newArr;
// }
export const getAgentArr = () => {
  return newArr;
